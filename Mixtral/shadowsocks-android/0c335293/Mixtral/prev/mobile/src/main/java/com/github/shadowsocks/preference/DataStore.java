...
public class DataStore implements PreferenceDataStore {
    public Boolean getBoolean(String key) {
        ...
        return kvPair != null ? kvPair.booleanValue() : null;
    }

    public Float getFloat(String key) {
        KeyValuePair kvPair = DBHelper.kvPairDao.queryForId(key);
        return kvPair != null ? kvPair.floatValue() : null;
    }

    public Integer getInt(String key) {
        KeyValuePair kvPair = DBHelper.kvPairDao.queryForId(key);
        return kvPair != null ? kvPair.intValue() : null;
    }

    public Long getLong(String key) {
        KeyValuePair kvPair = DBHelper.kvPairDao.queryForId(key);
        return kvPair != null ? kvPair.longValue() : null;
    }

    public String getString(String key) {
        KeyValuePair kvPair = DBHelper.kvPairDao.queryForId(key);
        return kvPair != null ? kvPair.stringValue() : null;
    }

    public Set<String> getStringSet(String key) {
        KeyValuePair kvPair = DBHelper.kvPairDao.queryForId(key);
        return kvPair != null ? kvPair.stringSetValue() : null;
    }
    ...
    private final int userIndex = Binder.getCallingUserHandle().hashCode();

    private int getLocalPort(String key, int default) {
        Integer value = getInt(key);
        return value != null ? value : parsePort(getString(key), default + userIndex);
    }
