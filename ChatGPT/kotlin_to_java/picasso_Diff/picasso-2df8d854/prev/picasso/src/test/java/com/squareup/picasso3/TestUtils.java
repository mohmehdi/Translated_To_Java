...
public class TestUtils {
    ...
    public static final Uri MEDIA_STORE_CONTENT_1_URL = Images.Media.EXTERNAL_CONTENT_URI.buildUpon().appendPath("1").build();
    public static final Uri MEDIA_STORE_CONTENT_2_URL = Video.Media.EXTERNAL_CONTENT_URI.buildUpon().appendPath("1").build();
    public static final String MEDIA_STORE_CONTENT_KEY_1 = new Request.Builder(MEDIA_STORE_CONTENT_1