...
public class RetryConnectionTest {
  ...
  private final localhost handshakeCertificates = localhost();
  ...
  public void someFallbacksSupported() {
    ...
    TlsVersion[] enabledSocketTlsVersions = new TlsVersion[] {
      TlsVersion.TLS_1_2,
      TlsVersion.TLS_1_1,
      TlsVersion.TLS_1_0
    };
    ...
    Attempt attempt0 = routePlanner.planConnectToRoute(route)
