...
public class StoryViewModelFactory implements ViewModelProvider.Factory {
    ...
    private CommentsWithRepliesAndUsersUseCase commentsWithRepliesAndUsersUseCase;
    ...
    public StoryViewModelFactory(
            long storyId,
            GetStoryUseCase getStoryUseCase,
            PostStoryCommentUseCase postStoryComment,
            PostReplyUseCase postReply,
            CommentsWithRepliesAndUsersUseCase commentsWithRepliesAndUsersUseCase,
        ...
        this.commentsWithRepliesAndUsersUseCase = commentsWithRepliesAndUsersUseCase;
