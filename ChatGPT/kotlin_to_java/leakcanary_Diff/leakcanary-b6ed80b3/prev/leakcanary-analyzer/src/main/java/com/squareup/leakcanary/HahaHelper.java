...
public class HahaHelper {
  ...
  public static String valueAsString(Object value) {
    ...
    if (value == null) {
      ...
      String valueClassName = classInstance.getClassObj().getClassName();
  ...
  public static boolean isPrimitiveWrapper(Object value) {
    ...
    ClassInstance classInstance = (ClassInstance) value;
    return WRAPPER_TYPES.contains(classInstance.getClassObj().getClassName());
  }
  ...
  public static boolean isPrimitiveOrWrapperArray(Object value) {
    ...
    return WRAPPER_TYPES.contains(classInstance.getClassName());
  }
  ...
  public static <T> T staticFieldValue(
    ...
    for (ClassObj.FieldValue fieldValue : classObj.getStaticFieldValues().entrySet()) {
      if (fieldValue.getKey().getName().equals(fieldName)) {
        @SuppressWarnings("unchecked")
        T value = (T) fieldValue.getValue();
        return value;
      }
