...
public class NewCommentRequest {
    ...
    public NewCommentRequest(String body, String parent_comment, String story, String user, PostCommentRequest comment) {
        this.body = body;
    ...
    public boolean equals(Object other) {
        ...
        if (!comment.equals(otherRequest.comment)) return false;
