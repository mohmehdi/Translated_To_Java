...
public class DesignerNewsRepository {
    ...
    private final Map<String, Call<*>> inflight = new HashMap<>();
    ...
    public void search(
            String query, int page, LoadSourceCallback callback) {
    ...
    public void cancelAllRequests() {
        for (Call<?> request : inflight.values()) request.cancel();
    }
    ...
    public static DesignerNewsRepository getInstance(DesignerNewsService service) {
        DesignerNewsRepository instance = INSTANCE;
        if (instance == null) {
    ...
    private static volatile DesignerNewsRepository INSTANCE;
}