...
public class LoginRepository {
  ...
  // Volatile keyword doesn't have a direct equivalent in Java, so we use AtomicReference instead
  private static final AtomicReference<LoginRepository> INSTANCE = new AtomicReference<>();
}
