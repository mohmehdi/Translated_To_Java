...
public class Exchange {
  ...
  public ResponseBody openResponseBody(Response response) throws IOException {
    try {
      ...
      Source responseBodySource = new ResponseBodySource(rawSource, contentLength);
      return new RealResponseBody(contentType, contentLength, responseBodySource.buffer());
    } catch (IOException e) {
      eventListener.responseFailed(call, e);
      trackFailure(e);
      throw e;
  ...
  public Headers trailers() throws SocketException {
    return codec.trailers();
  }

  public RealWebSocket.Streams newWebSocketStreams() throws IOException {
