...
public class SourceUiModel {
    ...
    public SourceUiModel(String key, String name, boolean active, int iconRes, boolean isSwipeDismissable,
                         OnSourceClickedListener onSourceClicked, OnSourceDismissedListener onSourceDismissed) {
        this.key = key;
        this.name = name;
        this.active = active;
