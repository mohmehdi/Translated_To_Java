...
public class FirebaseUserInfo implements AuthenticatedUserInfo {
    ...
    public Long getLastSignInTimestamp() {
        return firebaseUser != null && firebaseUser.getMetadata() != null ? firebaseUser.getMetadata().getLastSignInTimestamp() : null;
    }

    @Override
    public Long getCreationTimestamp() {
        return firebaseUser != null && firebaseUser.getMetadata() != null ? firebaseUser.getMetadata().getCreationTimestamp() : null;
    }
}