...
public final class FakeRepository implements TasksRepository {
    ...
    public LiveData<Result<Task>> observeTask(String taskId) {
        runBlocking(new SuspendLambda(this, taskId) {
            public Object invokeSuspend(Object $result, Continuation $completion) {
                this.this$0.refreshTasks($completion);
                return $result;
            }
    ...
    public static final class SuspendLambda extends RestrictedSuspendLambda<Object> implements SuspendFunction<Object>, Continuation<Unit> {
        public final FakeRepository this$0;

        public SuspendLambda(FakeRepository fakeRepository) {
            this.this$0 = fakeRepository;
        }

        public SuspendLambda(FakeRepository fakeRepository, String taskId) {
            this.this$0 = fakeRepository;
        }
        ...
        @Override
        public Continuation<Unit> create(Object result, Continuation<?> completion) {
            return new SuspendLambda(this.this$0);
        }
    }
}
