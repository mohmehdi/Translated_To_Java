...
public class TestData {
    ...
    public static final DesignerNewsSearchSource designerNewsSource =
    ...
    public static final DribbbleSourceItem dribbbleSource =
            new DribbbleSourceItem("dribbble", true);
    ...
    public static final User player =
            new User(
                    1,
                    "Nick Butcher",
                    "nickbutcher",
    ...
    public static final StoryLinks storyLinks =
            new StoryLinks(
                    userId,
                    commentIds,
                    new ArrayList<Long>(),
