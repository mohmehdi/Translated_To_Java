...
public class SignInDialogFragment extends DaggerAppCompatDialogFragment {
                ...
                if (request.peekContent() == RequestSignIn) {
                    ...
                    if (getActivity() != null) {
                        if (signInHandler.makeSignInIntent() != null) {
                            startActivityForResult(signInHandler.makeSignInIntent(), SIGN_IN_ACTIVITY_REQUEST_CODE);
                            dismiss();
                        }
                    }
                }
    ...
    public static final String DIALOG_NEED_TO_SIGN_IN = "dialog_sign_in";
    public static final int SIGN_IN_ACTIVITY_REQUEST_CODE = 42;
}