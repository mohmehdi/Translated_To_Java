...
public class UserRemoteDataSourceTest {
    ...
    public void getUsers_withSuccess() throws Exception {
        ...
        Result<List<User>> result = dataSource.getUsers(List.of(111L, 222L));
    ...
    private void withUsersSuccess(String ids, List<User> users) {
        ...
        Mockito.`when`(service.getUsers(ids)).thenReturn(CompletableDeferred.completableDeferred(result));
    }
