...
import io.plaidapp.core.data.comments.model.Comment;
...
import io.plaidapp.core.designernews.domain.model.DesignerNewsUser;
...
public class PostStoryCommentUseCase {
  ...
  public Result<Comment> invoke(String body, long storyId) {
    DesignerNewsUser user = loginRepository.getUser();
    if (user == null) {
