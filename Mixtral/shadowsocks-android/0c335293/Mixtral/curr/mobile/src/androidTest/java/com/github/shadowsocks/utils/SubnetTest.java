...
public class SubnetTest {
    ...
    public void parsingAndEquals() {
        Assert.assertEquals(Subnet.fromString("1.10.11.12/25"), Subnet.fromString("1.10.11.12/25"));
        Assert.assertEquals(Subnet.fromString("12.118.130.86/32"), Subnet.fromString("12.118.130.86"));
        Assert.assertEquals(Subnet.fromString("caec:cec6:c4ef:bb7b:1a78:d055:216d:3a78/96"),
                Subnet.fromString("caec:cec6:c4ef:bb7b:1a78:d055:216d:3a78/96"));
        Assert.assertEquals(Subnet.fromString("be37:44bd:8630:7a0:2a3d:ff95:dd33:42f0"),
