...
public class RequestCreator {
    ...
    Bitmap get() throws IOException {
        ...
        GetAction action = forRequest(picasso, picasso.dispatcher, picasso.cache, new GetAction(picasso, request));
        RequestHandler.Result result = action.hunt();
        if (result == null) {
            return null;
        }
    ...
    void into(RemoteViews remoteViews, @IdRes int viewId, int notificationId, Notification notification, String notificationTag, Callback callback) {
        long started = System.nanoTime();
    ...
    void into(RemoteViews remoteViews, @IdRes int viewId, int appWidgetId, Callback callback) {
        into(remoteViews, viewId, new int[]{appWidgetId}, callback);
    }

    void into(RemoteViews remoteViews, @IdRes int viewId, int[] appWidgetIds, Callback callback) {
        long started = System.nanoTime();
