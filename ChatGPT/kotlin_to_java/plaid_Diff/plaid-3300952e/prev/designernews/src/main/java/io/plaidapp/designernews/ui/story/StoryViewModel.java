...
public class StoryViewModel extends ViewModel {
    ...
    public StoryViewModel(
            ...
            CommentsWithRepliesAndUsersUseCase commentsWithRepliesAndUsers,
    ...
    private void getComments() {
        launch(contextProvider.getIO(), parentJob, new Function2<CoroutineScope, Continuation<? super Unit>, Object>() {
            @Override
            public Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                Result<List<Comment>> result = commentsWithRepliesAndUsers.invoke(story.getLinks().getComments());
                if (result instanceof Result.Success) {
