...
public class FirebaseSignInViewModelDelegateTest {
    ...
    public void testSignedOut() {
        ...
        AuthenticatedUserInfoBasic currentFirebaseUser = LiveDataTestUtil.getValue(subject.getCurrentUserInfo());
        TestCase.assertEquals(
                null,
                currentFirebaseUser != null ? currentFirebaseUser.getUid() : null
        );
        TestCase.assertEquals(
                null,
                LiveDataTestUtil.getValue(subject.getCurrentUserImageUri())
        );
        TestCase.assertFalse(subject.isSignedIn());
    }
    ...
    public void testSignedInRegistered() {
        ...
        TestCase.assertEquals(
                user.getUid(),
                LiveDataTestUtil.getValue(subject.getCurrentUserInfo()) != null ? LiveDataTestUtil.getValue(subject.getCurrentUserInfo()).getUid() : null
        );
        TestCase.assertEquals(
                user.getPhotoUrl(),
                LiveDataTestUtil.getValue(subject.getCurrentUserImageUri())
