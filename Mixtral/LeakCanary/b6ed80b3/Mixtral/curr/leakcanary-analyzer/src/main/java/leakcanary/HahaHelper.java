...
public class HahaHelper {
  ...
  public static String valueAsString(Object value) {
    ...
    if (value == null) {
      ...
      String valueClassName = ((ClassInstance) value).classObj.className;
  ...
  public static boolean isPrimitiveOrWrapperArray(Object value) {
    if (value instanceof ArrayInstance) {
      return ((ArrayInstance) value).arrayType != Type.OBJECT
          || WRAPPER_TYPES.contains(((ClassInstance) value).classObj.className);
    }
    return false;
  }
  ...
  public static <T> T staticFieldValue(
      ClassObj classObj,
      String fieldName) {
    for (Object.Entry<ClassObj.Field, Object> entry : classObj.staticFieldValues.entrySet()) {
