...
public class RequestCreatorTest {
    private final ArgumentCaptor<Action> actionCaptor = argumentCaptor();
...
public void intoImageViewWithQuickMemoryCacheCheckDoesNotSubmit() {
    ...
    Picasso picasso = spy(new Picasso.Builder(RuntimeEnvironment.application).build());
...
public void intoImageViewWithFitAndNoDimensionsQueuesDeferredImageViewRequest() {
    ImageViewTarget target = mockFitImageViewTarget(true);
