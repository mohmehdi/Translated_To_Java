...
public class DisplayLeakConnectorView extends View {
    ...
    public DisplayLeakConnectorView(Context context, AttributeSet attrs) {
        ...
        leakPaint.setStyle(Style.STROKE);
        ...
        PathEffect pathEffect = new DashPathEffect(new float[]{pathLines, pathGaps}, 0);
        leakPaint.setPathEffect(pathEffect);
    ...
    private void drawRoot(Canvas cacheCanvas) {
        ...
        final int height = getMeasuredHeight();
        final int halfWidth = width / 2;
        final float radiusClear = halfWidth - strokeSize / 2;
    ...
    private void drawArrowHead(
        ...
        cacheCanvas.drawLine(halfWidth, 0, halfWidth, lineYEnd, paint);
        cacheCanvas.translate(halfWidth, translateY);
        cacheCanvas.rotate(45);
        cacheCanvas.drawLine(
                0, halfWidth, halfWidth + halfStrokeSize, halfWidth,
                paint);
        cacheCanvas.drawLine(halfWidth, 0, halfWidth, halfWidth, paint);
        cacheCanvas.rotate(-45);
        cacheCanvas.translate(-halfWidth, -translateY);
    }
