...
public class AnalysisResult implements Serializable {
    ...
    public AnalysisResult(String referenceKey, String referenceName, boolean leakFound, boolean excludedLeak, String className, LeakTrace leakTrace, Throwable failure, long retainedHeapSize, long analysisDurationMs, long watchDurationMs) {
    ...
    public static AnalysisResult leakDetected(String referenceKey, String referenceName, boolean excludedLeak, String className, LeakTrace leakTrace, long retainedHeapSize, long analysisDurationMs, long watchDurationMs) {
        return new AnalysisResult(
                referenceKey,
                referenceName,
                true,
