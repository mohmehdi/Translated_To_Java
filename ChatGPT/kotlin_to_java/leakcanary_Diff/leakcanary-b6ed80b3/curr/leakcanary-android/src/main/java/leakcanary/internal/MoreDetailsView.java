...
public class MoreDetailsView extends View {
    ...
    public MoreDetailsView(Context context, AttributeSet attrs) {
        ...
        android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.leak_canary_MoreDetailsView);
        int plusColor = a.getColor(R.styleable.leak_canary_MoreDetailsView_leak_canary_plus_color, Color.BLACK);
        a.recycle();
