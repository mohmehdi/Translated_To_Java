...
public abstract class ScheduleChildFragmentsModule {
    ...
    public abstract AndroidInjector<ScheduleDayFragment> contributeScheduleDayFragment();

    @ChildFragmentScoped
    @ContributesAndroidInjector
    public abstract AndroidInjector<ScheduleAgendaFragment> contributeScheduleAgendaFragment();
}