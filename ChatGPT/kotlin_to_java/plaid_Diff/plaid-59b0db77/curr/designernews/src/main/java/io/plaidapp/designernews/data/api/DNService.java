...
public interface DNService {
    ...
    @GET("search?t=story")
    Deferred<Response<List<String>>> search(@Query("q") String query, @Query("p") Integer page);
    ...
    Deferred<Response<PostCommentResponse>> comment(@Body NewCommentRequest comment);
