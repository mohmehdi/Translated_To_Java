...
import android.os.Build.VERSION_CODES_ICE_CREAM_SANDWICH;
import android.os.Build.VERSION_CODES_ICE_CREAM_SANDWICH_MR1;
import android.os.Build.VERSION_CODES_JELLY_BEAN;
import android.os.Build.VERSION_CODES_JELLY_BEAN_MR2;
import android.os.Build.VERSION_CODES_KITKAT;
import android.os.Build.VERSION_CODES_LOLLIPOP;
import android.os.Build.VERSION_CODES_LOLLIPOP_MR1;
import android.os.Build.VERSION_CODES_M;
import android.os.Build.VERSION_CODES_N;
import android.os.Build.VERSION_CODES_N_MR1;
import android.os.Build.VERSION_CODES_O;
import android.os.Build.VERSION_CODES_O_MR1;
import android.os.Build.VERSION_CODES_P;
import com.squareup.leakcanary.internal.LeakCanaryInternals;
import com.squareup.leakcanary.internal.LeakCanaryInternals.HUAWEI;
import com.squareup.leakcanary.internal.LeakCanaryInternals.LENOVO;
import com.squareup.leakcanary.internal.LeakCanaryInternals.LG;
import com.squareup.leakcanary.internal.LeakCanaryInternals.MEIZU;
import com.squareup.leakcanary.internal.LeakCanaryInternals.MOTOROLA;
import com.squareup.leakcanary.internal.LeakCanaryInternals.NVIDIA;
import com.squareup.leakcanary.internal.LeakCanaryInternals.SAMSUNG;
import com.squareup.leakcanary.internal.LeakCanaryInternals.VIVO;
      ...
      excluded.instanceField("android.view.accessibility.AccessibilityNodeInfo", "mOriginalText")
          .reason(
              "AccessibilityNodeInfo has a static sPool of AccessibilityNodeInfo. When"
                  ...
                  + " whole view hierarchy. Introduced here: https:"
  ...
  GESTURE_BOOST_MANAGER(HUAWEI == Build.MANUFACTURER && VERSION.SDK_INT >= N && VERSION.SDK_INT <= N_MR1) {
    ...
    public void add(ExcludedRefs.Builder excluded) {
      excluded.staticField("android.gestureboost.GestureBoostManager", "mContext")
          .reason(
              "GestureBoostManager is a static singleton that leaks an activity context." + " Fix: https:"
          );
    }
  },
      ...
      excluded.instanceField("android.sec.clipboard.ClipboardUIManager", "mContext")
          .reason(
              "ClipboardUIManager is a static singleton that leaks an activity context."
                  ...
                  + " application context. Example: https:"
  ...
  SEM_EMERGENCY_MANAGER__MCONTEXT(SAMSUNG == Build.MANUFACTURER && VERSION.SDK_INT >= KITKAT && VERSION.SDK_INT <= N) {
    ...
    public void add(ExcludedRefs.Builder excluded) {
      excluded.instanceField("com.samsung.android.emergencymode.SemEmergencyManager", "mContext")
          .reason(
              "SemEmergencyManager is a static singleton that leaks a DecorContext." + " Fix: https:"
          );
    }
  },
