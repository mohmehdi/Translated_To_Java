...
public class PicassoTest {
    ...
    public void setUp() {
        ...
        bitmap = makeBitmap();
        picasso = new Picasso.Builder(RuntimeEnvironment.application)
                .context(context)
...
public void evictAll() {
    Picasso picasso = new Picasso.Builder(RuntimeEnvironment.application).indicatorsEnabled(true).build();
    picasso.cache.put("key", android.graphics.Bitmap.createBitmap(1, 1, ALPHA_8));
...
public void cloneSharesStatefulInstances() {
    ...
    private void verifyActionComplete(FakeAction action) {
        Result result = action.getCompletedResult();
        Truth.assertThat(result).isNotNull();
        Truth.assertThat(result).isInstanceOf(BitmapResult.class);
