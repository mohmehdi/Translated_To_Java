...
public class QuickAdapterHelper {
    ...
    private List<RecyclerView.Adapter<?>> mHeaderList = new ArrayList<>(0);
    private List<RecyclerView.Adapter<?>> mFooterList = new ArrayList<>(0);
    ...
    private LoadState leadingLoadState;
    public LoadState getLeadingLoadState() {
        return leadingLoadStateAdapter != null ? leadingLoadStateAdapter.getLoadState() : new LoadState.NotLoading(false);
    }
    ...
    private LoadState trailingLoadState;
    public LoadState getTrailingLoadState() {
        return trailingLoadStateAdapter != null ? trailingLoadStateAdapter.getLoadState() : new LoadState.NotLoading(false);
    }
    ...
    public QuickAdapterHelper(BaseQuickAdapter<?, ?> contentAdapter, LeadingLoadStateAdapter<?> leadingLoadStateAdapter, TrailingLoadStateAdapter<?> trailingLoadStateAdapter, ConcatAdapter.Config config, DragAndSwipeImpl dragAndSwipe) {
    ...
    public QuickAdapterHelper removeAdapter(RecyclerView.Adapter<?> a) {
        if (a == contentAdapter) {
            return this;
        }
    ...
    public QuickAdapterHelper startDrag(int position) {
        if (dragAndSwipe != null) {
    ...
    public QuickAdapterHelper startDrag(RecyclerView.ViewHolder holder) {
        if (dragAndSwipe != null) {
    ...
    public static class Builder {
        ...
        public Builder attachToDragAndSwipe(@Nullable RecyclerView recyclerView, int dragMoveFlags, int swipeMoveFlags) {
        ...
        public Builder setItemDragListener(OnItemDragListener mOnItemDragListener) {
            checkDragAndSwipeCallback();
        ...
        public void checkDragAndSwipeCallback() {
