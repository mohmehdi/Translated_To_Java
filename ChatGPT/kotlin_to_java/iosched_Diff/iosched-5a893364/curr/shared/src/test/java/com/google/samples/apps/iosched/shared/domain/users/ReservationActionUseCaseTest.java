...
public class ReservationActionUseCaseTest {
    ...
    public void sessionIsRequestedSuccessfully() {
        ReservationActionUseCase useCase = new ReservationActionUseCase(TestUserEventRepository);
    ...
    public void requestFails() {
        ReservationActionUseCase useCase = new ReservationActionUseCase(FailingUserEventRepository);
