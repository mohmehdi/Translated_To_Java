...
public class TaskDetailViewModelTest {
    ...
    public void completeTask() {
        ...
        assertSnackbarMessage(taskDetailViewModel.getSnackbarText(), R.string.task_marked_complete);
    }
    ...
    public void activateTask() {
        ...
        Truth.assertThat(tasksRepository.getTasksServiceData().get(task.getId()).isCompleted()).isFalse();
        assertSnackbarMessage(taskDetailViewModel.getSnackbarText(), R.string.task_marked_active);
    }
    ...
    public void updateSnackbar_nullValue() {
        String snackbarText = LiveDataTestUtil.getValue(taskDetailViewModel.getSnackbarText());
    ...
    public void clickOnEditTask_SetsEvent() {
        ...
        TaskDetailEvent value = LiveDataTestUtil.getValue(taskDetailViewModel.getEditTaskEvent());
