...
public class SignInModule {
    ...
    @Singleton
    @Provides
    public AuthStateUserDataSource provideAuthStateUserDataSource(FirebaseAuth firebase, FirebaseFirestore firestore) {
        return new FirebaseAuthStateUserDataSource(firebase, new FcmTokenUpdater(firestore));
    }
