...
class RealCall implements Call {
  ...
  private IOException messageDone(Exchange exchange, boolean requestDone, boolean responseDone, IOException e) {
  ...
  private IOException timeoutExit(IOException cause) {
    ...
    InterruptedIOException ioException = new InterruptedIOException("timeout");
    if (cause != null) ioException.initCause(cause);
    return ioException;
  }
    ...
    public void executeOn(ExecutorService executorService) {
        ...
        try {
            executorService.execute(() -> {
                // This lambda expression represents the 'this' keyword in Kotlin,
                // which refers to the instance of the outer class (RealCall)
