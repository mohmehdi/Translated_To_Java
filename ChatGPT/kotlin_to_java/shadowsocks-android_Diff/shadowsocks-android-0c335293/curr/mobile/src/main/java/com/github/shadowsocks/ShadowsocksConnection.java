...
public class ShadowsocksConnection implements ServiceConnection {
    ...
    public interface Interface extends IBinder.DeathRecipient {
        ...
        default boolean getListenForDeath() {
            return false;
        }
    ...
    public void connect() {
        ...
        Intent intent = new Intent((Context) instance, BaseService.serviceClass).setAction(Action.SERVICE);
