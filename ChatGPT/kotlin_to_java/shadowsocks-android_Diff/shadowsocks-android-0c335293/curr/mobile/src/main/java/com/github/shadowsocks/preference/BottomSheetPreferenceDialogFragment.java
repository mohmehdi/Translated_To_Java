...
public class BottomSheetPreferenceDialogFragment extends PreferenceDialogFragmentCompat {
            ...
            if (preference.selectedEntry < 0) {
                ...
                switch (position) {
                    case 0:
                        ...
                        break;
                    case preference.selectedEntry + 1:
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        int padding = getResources().getDimensionPixelOffset(R.dimen.bottom_sheet_padding);
        ...
        dialog.findViewById(R.id.touch_outside).setFocusable(false);
        return dialog;
    }
