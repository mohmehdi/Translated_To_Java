...
public class Injection {
    ...
    public static GetCommentsWithRepliesAndUsersUseCase provideCommentsWithRepliesAndUsersUseCase(Context context) {
    ...
    public static GetCommentsWithRepliesUseCase provideCommentsWithRepliesUseCase(CommentsRepository commentsRepository) {
        return new GetCommentsWithRepliesUseCase(commentsRepository);
    }

    public static GetCommentsWithRepliesAndUsersUseCase provideCommentsWithRepliesAndUsersUseCase(
            GetCommentsWithRepliesUseCase commentsWithGetCommentsWithReplies,
            UserRepository userRepository) {
        return new GetCommentsWithRepliesAndUsersUseCase(commentsWithGetCommentsWithReplies, userRepository);
    }
