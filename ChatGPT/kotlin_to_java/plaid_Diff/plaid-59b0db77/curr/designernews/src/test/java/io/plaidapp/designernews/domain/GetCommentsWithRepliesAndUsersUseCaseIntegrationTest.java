...
public class GetCommentsWithRepliesAndUsersUseCaseIntegrationTest {
    ...
    private DesignerNewsService designerNewsService = mock(DesignerNewsService.class);
    ...
    private UserRepository userRepository = new UserRepository(new UserRemoteDataSource(designerNewsService));
